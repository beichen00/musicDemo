...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"\\jwt-shiro\\src\\main\\java");         //自定义代码生成后的存放目录
        gc.setAuthor("北陈");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/roletest?characterEncoding=utf-8");
